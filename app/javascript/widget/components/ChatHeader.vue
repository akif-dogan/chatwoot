...
<template>
  <header class="flex justify-between w-full px-5 py-4 gap-2" style="background: linear-gradient(135deg, #1e3a8a, #2563eb);">
        ...
        >
          ...
          <div
            :class="`h-2 w-2 rounded-full
              ${isOnline ? 'bg-emerald-400 animate-pulse' : 'hidden'}`"
          />
        </div>
